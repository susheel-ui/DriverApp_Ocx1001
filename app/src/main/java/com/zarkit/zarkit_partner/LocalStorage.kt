...
object LocalStorage {
    ...
    // -------------------------
    fun saveDriverOnlineStatus(context: Context, isOnline: Boolean) {
        context.getSharedPreferences(PREF_NAME, Context.MODE_PRIVATE)
            .edit()
            .putBoolean(KEY_DRIVER_ONLINE_STATUS, isOnline)
            .apply()
    }

    fun getDriverOnlineStatus(context: Context): Boolean {
        return context.getSharedPreferences(PREF_NAME, Context.MODE_PRIVATE)
            .getBoolean(KEY_DRIVER_ONLINE_STATUS, false)
    }

    fun clearDriverOnlineStatus(context: Context) {
        context.getSharedPreferences(PREF_NAME, Context.MODE_PRIVATE)
            .edit()
